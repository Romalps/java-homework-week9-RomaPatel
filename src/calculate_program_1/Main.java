...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Calculator calculator = new Calculator();// create an object of Calculator class
        char choice;
        ...
        do {
            ...
            calculator.calculateResult(a, b, symbol);// calling instance method from Calculator class
